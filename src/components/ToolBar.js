...
const ToolBar = ({ night, dayNightSwitch }) => {
    const [fullScreen, setFullScreen] = useState(false);

    const fullScreenSwitch = async () => {
    ...
    return (
        <div id='toolBar'>
            ...
            <button onClick={ fullScreenSwitch }>
                {
                    fullScreen
                        ?
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-fullscreen" viewBox="0 0 16 16">
